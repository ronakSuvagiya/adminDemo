...
CREATE TABLE `category_master` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKbi35hf6aq5lovvrkqklvrrtta` (`product_id`)
...
INSERT INTO `category_master` VALUES (1,NULL,'Home Loan',1),(2,NULL,'Car loan',1),(3,600,'Rent Aggriment',2),(4,600,'Pancard',2);
